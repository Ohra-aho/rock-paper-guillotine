...
public class AchievementMenu : MonoBehaviour
{
    ...
    string[][] achievements =
    {
        new string[] { "Tough", "Take damage 10 times during a single game." },
        ...
        new string[] { "Experimentor", "Use 12 different weapons during a single game." },
        ...
        new string[] { "Neurotic", "Own 3 rocks, 3 sicssors and 3 papers."},
        new string[] { "Plotter", "Win 4 fights with only effect damage dealing weapons equipped during a single game." },
        ...
        new string[] { "Picky", "Own 7 weapons you have never brought to a fight." },
